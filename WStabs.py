    ...
    def updateWidget(self):
        ...
        for goal_info in goals:
            ...
            if goal_info[10] or self.isSubgoalsShowing:
                ...
                goal_item.setIcon(0, QIcon(ws.getGoalImage(goal_info[7].split(",")[0], ws.calculate_progress(goal_info[8], goal_info[1], goal_info[9], goal_info[5]), goal_info[1]))) #��� �� �������� ������ ����������� �� ������ �����, ������� �������� �������
...
class Plans(QWidget):
    ...
    def __init__(self):
        ...
        next_week_button.setIcon(QIcon(i_dir + r"/next week.png"))
...
class PhrasesEditor(QDialog):
    ...
    def show_author_image(self, text, *args):
        print(text)
        image = DataManager.loadOtherData("author image", text, one=True)[0]
        print(image)
        if image:
